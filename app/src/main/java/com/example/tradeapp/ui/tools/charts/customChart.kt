...
//        ) {
//            Button (onClick = { selectedTimeRange = TimeRange.ONE_DAY_BEFORE }) {
//                Text("۱ روز قبل")
//            }
//            Button(onClick = { selectedTimeRange = TimeRange.ONE_DAY }) {
//                Text("۱ روز")
//            }
//            Button(onClick = { selectedTimeRange = TimeRange.FIVE_DAYS }) {
//                Text("۵ روز")
//            }
//            Button(onClick = { selectedTimeRange = TimeRange.ONE_MONTH }) {
//                Text("۱ ماه")
//            }
//            Button(onClick = { selectedTimeRange = TimeRange.FIVE_MONTHS }) {
//                Text("۵ ماه")
//            }
//            Button(onClick = { selectedTimeRange = TimeRange.ONE_YEAR }) {
//                Text("۱ سال")
//            }
//            Button(onClick = { selectedTimeRange = TimeRange.ALL }) {
//                Text("همه")
//            }
//        }
//    }
